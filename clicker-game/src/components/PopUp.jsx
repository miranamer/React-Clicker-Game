    ...
    <>
        <div className="fixed top-0 left-0 w-full h-screen bg-black/60 flex justify-center items-center">
            <div className="relative p-5 w-[900px] h-[600px] bg-white">
                ...
                {items.includes(1) ? <div className="drop-shadow-lg relative w-full h-[75px] bg-sky-300 mt-20 flex items-center">
                    ...
                    <button onClick={() => setItems(items.filter(item => item !== 1))} className='text-sky-600  border-sky-600 px-4 py-2 rounded-md border-2 absolute right-4'>100G</button>
                </div> : null}
                
                <div className=" drop-shadow-lg relative w-full h-[75px] bg-yellow-300 mt-10 flex items-center">
                    ...
                    <button className='text-yellow-600  border-yellow-600 px-4 py-2 rounded-md border-2 absolute right-4'>200G</button>
                </div>
                
                <div className="drop-shadow-lg relative w-full h-[75px] bg-purple-300 mt-10 flex items-center">
                    ...
                    <button className='text-purple-600  border-purple-600 px-4 py-2 rounded-md border-2 absolute right-4'>1000G</button>
                </div>
                
                <div className="drop-shadow-lg relative w-full h-[75px] bg-red-300 mt-10 flex items-center">
                    ...
                    <button className='text-red-600  border-red-600 px-4 py-2 rounded-md border-2 absolute right-4'>20000G</button>
                </div>
